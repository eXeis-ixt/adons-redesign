<section class="w-full  antialiase ">
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div
            ...
            <h1
                class="text-3xl font-bold leading-10 tracking-tight text-left text-white md:text-center sm:text-4xl md:text-7xl lg:text-8xl">
                Innovate, Excel <br class="hidden sm:block"> Succeed!</h1>
            <div class="mx-auto mt-5 text-gray-400 md:mt-8 md:max-w-lg md:text-center md:text-xl">Empowering your brand
                through creativity and technology.
                The solution to your bussiness</div>
            <div
                ...
                <span class="relative inline-flex w-full md:w-auto">
                    <a href="#_"
                        class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-medium leading-6 text-white bg-neutral-900 border border-transparent rounded-full xl:px-10 md:w-auto hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
                        Get in touch
                    </a>
                </span>
                <span class="relative inline-flex w-full md:w-auto">
                    <a href="{{route('feature')}}" wire:navigate
                        class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-medium leading-6 text-white  border border-transparent rounded-full xl:px-10 md:w-auto  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200">Learn More</a>
                </span>
            </div>
        </div>
    ...
    <section class="  bg-[#0A0A0A]">
        ...
        <section class="">
            <h1 class="text-sm font-bold tracking-wide text-center text-gray-300 uppercase mb-7">Trusted by top-leading
                companies.</h1>
            ...
            <div class="max-w-6xl px-12 mx-auto text-center">
                <div class="space-y-12 md:text-center">
                    <div class="max-w-3xl mb-20 space-y-5 sm:mx-auto sm:space-y-4">
                        <h2 class="relative text-4xl font-extrabold text-white tracking-tight sm:text-5xl">Our Awesome
                            Team</h2>
                ...
                <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="w-full  rounded-lg shadow-sm">
                        ...
                        <div class="flex flex-col items-center justify-center p-10">
                            <img class="w-32 rounded-md mb-6 "
                                src="https://adons.org/storage//w85gElnipHfn62HETKyZJIpnMSTXl7-metaSU1HXzQ1OTgucG5n-.webp">
                            <h2 class="text-lg font-medium text-white">John Doe</h2>
                            <p class="font-medium text-gray-500">CEO and Founder</p>
                            <p class="text-gray-400">Team member as of 2015
                        </div>

                        <div class="flex border-t border-neutral-900 divide-x divide-neutral-900">
                            <a href="#_"
                                class="flex-1 block p-5 text-center text-gray-300 transition duration-200 ease-out hover:bg-gray-100 hover:text-black">
                            ...
                            <a href="#_"
                                class="flex-1 block p-5 text-center text-gray-300 transition duration-200 ease-out hover:bg-white hover:text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-auto fill-current"
                                    viewBox="0 0 24 24">
                                    <path
        ...
        <section class=" mt-32 flex items-center justify-center py-20  min-w-screen">
            <div class="px-16 ">
                <div class="container flex flex-col items-start mx-auto lg:items-center">
                    <p class="relative flex items-start justify-start w-full text-lg font-bold tracking-wider text-gray-300 uppercase lg:justify-center lg:items-center" data-primary="purple-500">Don't just take our word for it</p>


                    <h2 class="relative flex items-start justify-start text-white w-full max-w-3xl text-5xl font-bold lg:justify-center">
